...
public class consultaHabitants {
    ...
    public static int consultaHabitants(String codiIdescatMunicipi) throws IOException {
        ...
        // Passem el municipi per l'URLEncoder per codificar els caràcters
        // que calgui perquè sigui vàlid com a part d'un URL.
        String nomMunicipiURL = URLEncoder.encode(codiIdescatMunicipi, "UTF-8");
        URL urlHabitants;
        

        urlHabitants = new URL("https://analisi.transparenciacatalunya.cat/resource/byd8-nf5f.csv?$where=nivell_poblacional="Municipi"+and+codi_municipi=\""+codiIdescatMunicipi+"\")");
